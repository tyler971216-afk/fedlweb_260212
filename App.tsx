...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Removed the ScrollTrigger animation for mainContentRef to eliminate perceived lag/delay 
    // when scrolling from Hero to main sections.
  ...
  return (
    <div className={`min-h-screen ${currentView === 'main' ? 'bg-[#131C31]' : 'bg-[#F8FAFC]'} overflow-x-hidden`}>
      <Navbar 
      ...
      {currentView === 'main' ? (
        <>
          ...
          <main ref={mainContentRef} className="relative z-10 bg-[#131C31]">
