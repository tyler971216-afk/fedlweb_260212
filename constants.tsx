...
export const MEMBERS: Member[] = [
  ...
  // Ph.D Students
  { id: 'phd1', name: '지승현', degree: 'Integrated M.S/Ph.D', email: 'qwas8802@yonsei.ac.kr', researchArea: '2D materials based electronics, Micro LED', image: '/images/members/sh.png', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd2', name: '홍주영', degree: 'Integrated M.S. / Ph.D.', email: 'juyoung518@gmail.com', researchArea: 'Wireless bio-medical devices', image: '/images/members/jy.png', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd3', name: 'Xu Duo', degree: 'Ph.D', email: 'duoxu97@outlook.com', researchArea: 'High-performance P-type 2D materials', image: '/images/members/duo.png', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd4', name: '이재도', degree: 'Integrate M.S/Ph.D', email: 'jaedo89@yonsei.ac.kr', researchArea: '2D materials based electronics, Gate Dielectric', image: '/images/members/jd.png', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd5', name: '김승수', degree: 'Integrate M.S/Ph.D', email: 'tyler971216@gmail.com', researchArea: '2D materials based electronics, Micro LED', image: '/images/members/ss.png', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd6', name: '유지훈', degree: 'Integrate M.S/Ph.D', email: 'jhryu960@yonsei.ac.kr', researchArea: '2D materials based electronics, Micro LED', image: '/images/members/jh.png', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd7', name: '윤석민', degree: 'Integrate M.S/Ph.D', email: 'ysm23@yonsei.ac.kr', researchArea: 'Foldable/Rollable display, Mechanical Analysis', image: '/images/members/sm.png', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd8', name: '최종규', degree: 'Integrate M.S/Ph.D', email: 'gui828@yonsei.ac.kr', researchArea: '2D material synthesis', image: '/images/members/jk.png', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd9', name: '김민규', degree: 'Integrate M.S/Ph.D', email: 'kmg9797@yonsei.ac.kr', researchArea: '2D materials based electronics, DRAM', image: '/images/members/mg_kim.png', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd10', name: '김진의', degree: 'Integrate M.S/Ph.D', email: 'jin1202vs@yonsei.ac.kr', researchArea: 'Software Platform for Wearable Electronics', image: '/images/members/je.png', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd11', name: '이재인', degree: 'Integrate M.S/Ph.D', email: 'jaeinlee1999@gmail.com', researchArea: '2D materials based high performance TFT', image: '/images/members/ji.png', role: 'Ph.D Student', category: 'Ph.D students' },
  ...
  { id: 'phd13', name: '김정근', degree: 'Integrate M.S/Ph.D', email: 'jeongkeun37@yonsei.ac.kr', researchArea: '', image: '/images/members/jk_kim.png', role: 'Ph.D Student', category: 'Ph.D students' },
  
  // M.S Students
  { id: 'ms1', name: '양승민', degree: 'M.S.', email: 'ysmsis44@yonsei.ac.kr', researchArea: '2D materials based electronics, DRAM', image: '/images/members/sm_yang.png', role: 'M.S Student', category: 'M.S students' },
  { id: 'ms2', name: '김하영', degree: 'M.S.', email: 'wonan0254@yonsei.ac.kr', researchArea: '2D materials based electronics, P-type', image: '/images/members/hy_kim.png', role: 'M.S Student', category: 'M.S students' },
  { id: 'ms3', name: '최민규', degree: 'M.S.', email: 'rb0401@yonsei.ac.kr', researchArea: '', image: '/images/members/mk_choi.png', role: 'M.S Student', category: 'M.S students' },
