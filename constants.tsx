...
export const MEMBERS: Member[] = [
  ...
  },
  {
    ...
    nameEn: ' ',
    role: 'Postdoctoral researcher',
    email: 'duoxu97@outlook.com',
    researchArea: '2D materials based electronics, Bio-medical',
    image: '/images/members/duo.jfif',
    category: 'Post doctors'
  },
  
  // Ph.D Students
  { id: 'phd1', name: '홍주영', degree: 'Integrated M.S/Ph.D.', email: 'juyoung518@gmail.com', researchArea: 'Wireless bio-medical devices', image: '/images/members/jy.jpg', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd2', name: '이재도', degree: 'Integrate M.S/Ph.D', email: 'jaedo89@yonsei.ac.kr', researchArea: '2D materials based electronics, Gate Dielectric', image: '/images/members/jd.jfif', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd3', name: '김승수', degree: 'Integrate M.S/Ph.D', email: 'tyler971216@gmail.com', researchArea: '2D materials based electronics, Micro LED', image: '/images/members/ss.jfif', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd4', name: '유지훈', degree: 'Integrate M.S/Ph.D', email: 'jhryu960@yonsei.ac.kr', researchArea: '2D materials based electronics, Micro LED', image: '/images/members/jh.jfif', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd5', name: '윤석민', degree: 'Integrate M.S/Ph.D', email: 'ysm23@yonsei.ac.kr', researchArea: 'Foldable/Rollable display, Mechanical Analysis', image: '/images/members/sm.jfif', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd6', name: '최종규', degree: 'Integrate M.S/Ph.D', email: 'gui828@yonsei.ac.kr', researchArea: '2D material synthesis', image: '/images/members/jk.jfif', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd7', name: '김민규', degree: 'Integrate M.S/Ph.D', email: 'kmg9797@yonsei.ac.kr', researchArea: '2D materials based electronics, DRAM', image: '/images/members/mg_kim.jpg', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd8', name: '김진의', degree: 'Integrate M.S/Ph.D', email: 'jin1202vs@yonsei.ac.kr', researchArea: 'Software Platform for Wearable Electronics', image: '/images/members/je.jfif', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd9', name: '이재인', degree: 'Integrate M.S/Ph.D', email: 'jaeinlee1999@gmail.com', researchArea: '2D materials based high performance TFT', image: '/images/members/ji.jfif', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd10', name: '김민준', degree: 'Integrate M.S/Ph.D', email: 'kmj12385@yonsei.ac.kr', researchArea: 'Foldable/Rollable display, Mechanical Analysis', image: '/images/members/mj.png', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd11', name: '김정근', degree: 'Integrate M.S/Ph.D', email: 'jeongkeun37@yonsei.ac.kr', researchArea: '2D materials based electronics, Memristor', image: '/images/members/jk_kim.jfif', role: 'Ph.D Student', category: 'Ph.D students' },
  { id: 'phd12', name: '내경한', degree: 'Integrate M.S/Ph.D', email: '2026324180@yonsei.ac.kr', researchArea: '2D materials based electronics, Micro LED', image: '/images/members/kh_nae.jpg', role: 'Ph.D Student', category: 'Ph.D students' },
...
//gallery 사진
  ...
  { 
    ...
    date: '2023-08-09', 
    type: 'Gallery', 
    image: '/images/gallery/[2023.08.09]/1.jpg',
    images: [
      '/images/gallery/[2023.08.09]/1.jpg',
      '/images/gallery/[2023.08.09]/2.jpg'
    ]
  },
  { 
    id: 'g9', 
    ...
    date: '2023-07-30', 
    type: 'Gallery', 
    image: '/images/gallery/[2023.07.30]/1.jpg'
  },
  { 
    id: 'g10', 
    title: '스승의 날(National Teacher Day)', 
    date: '2023-05-20', 
    type: 'Gallery', 
    image: '/images/gallery/[2023.05.20]/1.jpg',
    images: [
      '/images/gallery/[2023.05.20]/1.jpg',
      '/images/gallery/[2023.05.20]/2.jpg'
    ]
  },
  { 
    id: 'g11', 
    ...
    date: '2020-05-16', 
    type: 'Gallery', 
    image: '/images/gallery/[2020.05.16] Teacher Day.jpg'
  },
  { 
    id: 'g12', 
    title: '20년도 졸업생 송별회', 
    date: '2020-02-20', 
    type: 'Gallery', 
    image: '/images/gallery/[2020.02.20] farewell.jpg'
  },
  { 
    id: 'g13', 
    title: 'Workshop in Jeju', 
    date: '2018-11-13', 
    type: 'Gallery', 
    image: '/images/gallery/[2017.11.06] Workshop in Jeju.jpg'
  },
  { 
    id: 'g14', 
    title: 'FREE 학회', 
    date: '2018-11-02', 
    type: 'Gallery', 
    image: '/images/gallery/[2018.11.02] FREE.jpg'
  },
  { 
    id: 'g15', 
    ...
    date: '2018-09-17', 
    type: 'Gallery', 
    image: '/images/gallery/[2018.09.17].jpg'
  },
  { 
    id: 'g16', 
    title: 'Workshop in Jeju', 
  ...
  { id: 'nw5', date: '10/08/2023', title: '유연 기판 위에서 2D 반도체 직접 만든다', source: '조선비즈', type: 'News', link: 'https://n.news.naver.com/article/366/0000923456'  },
  { id: 'nw6', date: '21/04/2023', title: '0.01초 찰나의 순간 감지하는 파리의 눈… 영상 센서로 구현했다', source: '조선비즈', type: 'News', link: 'https://n.news.naver.com/article/366/0000895479' },
  { id: 'nw7', date: '31/01/2023', title: 'MicroLEDs that can flex', source: 'Nature Electronics', type: 'News', link: 'https://www.nature.com/articles/s41928-023-00921-3' },
  { id: 'nw8', date: '25/02/2022', title: '연세대 연구팀, \'사람 눈처럼 명암 신속 식별\' 센서기술 개발', source: '연합뉴스', type: 'News', link: 'https://n.news.naver.com/article/001/0013012315?lfrom=kakao' },
  { id: 'nw9', date: '25/02/2022', title: '연세대 연구팀, \'사람 눈처럼 명암 신속 식별…', source: '한국경제', type: 'News', link: 'https://www.hankyung.com/society/article/202202259798Y' },
  { id: 'nw10', date: '25/02/2022', title: '[연구 프론티어] 안종현 교수팀, 인간의 망막을 모사한 스마트 이미지 센서 기술 개발', source: '연세소식', type: 'News', link: 'https://www.yonsei.ac.kr/ocx/news.jsp?mode=view&ar_seq=20220225101117622039&sr_volume=631&list_mode=list&sr_site=S&pager.offset=0&sr_cates=25' },
  { id: 'nw11', date: '08/02/2022', title: 'Retina-like sensors give machines better vision', source: 'Nature', type: 'News', link: 'https://www.nature.com/articles/d41586-022-00360-8' },
  { id: 'nw12', date: '03/11/2021', title: 'A decade of R2R graphene manufacturing', source: 'Nature Nanotechnology', type: 'News', link: 'https://www.nature.com/articles/s41565-021-00990-5' },
  { id: 'nw13', date: '22/02/2021', title: '대중화 가로막던 ‘자율주행자동차의 눈’ 실리콘 기반 라이다(Lidar) 센서 개발로 난제 극복', source: '사이언스21', type: 'News', link: 'http://s21.co.kr/news_view.jsp?ncd=3687%22' },
  { id: 'nw14', date: '01/02/2021', title: '이성규·이효철·윤후명·안종현, 제62회 3·1문화상 수상자 선정', source: '서울신문', type: 'News', link: 'https://www.seoul.co.kr/news/newsView.php?id=20210201026030&wlog_tag3=naver%22' },
  { id: 'nw15', date: '29/01/2021', title: '너무 비싼 센서 라이다, 자율주행 업계 ‘골머리', source: '정보통신신문', type: 'News', link: 'https://www.koit.co.kr/news/articleView.html?idxno=80662%22' },
  { id: 'nw16', date: '09/10/2020', title: '‘2020 노벨상’ 오늘부터 발표…한국인 수상자 나올까?', source: 'KBS NEWS', type: 'News', link: 'http://news.kbs.co.kr/news/view.do?ncd=5018086&ref=A%22' },
  { id: 'nw17', date: '30/07/2020', title: '\'차 한대 값’ 라이다 센서 제작비 10분의 1로 줄이는 韓 기술 나왔다', source: '조선비즈', type: 'News', link: 'https://n.news.naver.com/mnews/article/366/0000562635?sid=105' },
  { id: 'nw18', date: '05/07/2020', title: '[나노코리아]나노연구혁신상 부문 수상자', source: '전자신문', type: 'News', link: 'https://www.etnews.com/20200630000390' },
  { 
    id: 'nw19', 
    date: '21/11/2019', 
  ...
  { id: 'nw20', date: '05/10/2019', title: '“노벨상 근접 국내 과학자 17人”…서울대·카이스트 등 연구진 포함', source: '동아일보', type: 'News', link: 'http://www.donga.com/news/article/all/20191005/97739303/1' },
  { id: 'nw21', date: '28/11/2018', title: '피인용 횟수 기준 세계에서 가장 영향력 있는 1% 연구자 선정', source: '연합뉴스, Clarivate Analytics, HCR', type: 'News', link: 'https://news.naver.com/main/read.nhn?mode=LSD&mid=sec&sid1=105&oid=001&aid=0010492712' },
  { id: 'nw22', date: '16/09/2018', title: '‘휘는 스마트폰 기술’ 안종현 교수 등 6명 대한민국학술원상', source: '서울신문', type: 'News', link: 'http://seoul.co.kr/news/newsView.php?id=20180917027003' },
  { id: 'nw23', date: '31/07/2018', title: '휘어지는 스마트폰, 엉뚱한 상상에서 시작됐죠', source: '조선일보 People & Story', type: 'News', link: 'https://drive.google.com/file/d/13M14dE4QGOv8cb1nwhvlM5oSuugCh4Dn/view?usp=sharing' },
  { id: 'nw24', date: '12/07/2018', title: '마이크로 LED 디스플레이, bLED+QD가 현실적 대안', source: 'KiPOST', type: 'News', link: 'https://www.kipost.net/bbs/board.php?bo_table=display_news&wr_id=803' },
  { id: 'nw25', date: '06/07/2018', title: 'Factors that make an impact', source: 'Nature Nanotechnology Editorial Paper', type: 'News', link: 'https://www.nature.com/articles/s41565-018-0215-y' },
  { id: 'nw26', date: '06/07/2018', title: 'From an idea to a technology', source: 'Nature Nanotechnology Q&A News', type: 'News', link: 'https://www.nature.com/articles/s41565-018-0206-z' },
  { id: 'nw27', date: '12/06/2018', title: '연세대 연구진, 체내 분해되는 뇌질환 진단 신기술 개발', source: '연합뉴스', type: 'News', link: 'http://www.yonhapnews.co.kr/bulletin/2018/06/12/0200000000AKR20180612131400004.HTML?input=1195m' },
  { id: 'nw28', date: '18/05/2018', title: '다큐S 프라임 68회 - 신비한 물질, 유리 편 인터뷰', source: 'YTN SCIENCE', type: 'News', link: 'https://youtu.be/m20df6cIcxs?t=9m35s_8?t=575' },
  { id: 'nw29', date: '09/05/2018', title: '피부에 붙일 수 있는 유연한 초박막 디스플레이 개발', source: '연합뉴스', type: 'News', link: 'http://www.yonhapnews.co.kr/bulletin/2018/05/09/0200000000AKR20180509069100063.HTML?input=1195m' },
  { id: 'nw30', date: '20/04/2018', title: 'Stick-on Displays: Bendy 2D Semiconductor is Fast Enough to Drive OLED Pixels', source: 'IEEE Spectrum', type: 'News', link: 'https://spectrum.ieee.org/nanoclast/semiconductors/nanotechnology/embargoed-stickon-displays-bendy-2d-semiconductor-made-fast-enough-to-drive-oled-pixels' },
  { id: 'nw31', date: '18/04/2018', title: '연세대, 2차원 물질 기반 광검출소자 개발', source: '천지일보', type: 'News', link: 'http://www.newscj.com/news/articleView.html?idxno=513264' },
  { id: 'nw32', date: '03/07/2017', title: '세상을 바꾸는 시간, 15분 강연', source: 'CBS', type: 'News', link: 'http://www.cbs.co.kr/tv/pgm/vod.asp?pname=view&num=312016&pgm=1701&mcd=_REVIEW_&pgm2=&pgm_key=cbs15min' },
  { id: 'nw33', date: '04/08/2016', title: '전자피부로 활용 가능한 초박막 투명-유연 촉각센서 개발', source: '연합뉴스', type: 'News', link: 'http://www.yonhapnews.co.kr/bulletin/2018/05/09/0200000000AKR20180509069100063.HTML?input=1195m' },
  { id: 'nw34', date: '21/10/2015', title: '논문의 질(피인용)이 높은 공학분야 연구자 3위 선정', source: '중앙일보', type: 'News', link: 'http://graphene.yonsei.ac.kr/publications/2016/joong.pdf' },
  { id: 'nw35', date: '30/03/2014', title: '그래핀 결함 효율적 분석 기술 개발', source: 'SBS뉴스, 전자신문, 연합뉴스 등', type: 'News', link: 'http://news.sbs.co.kr/news/endPage.do?news_id=N1002319496' },
  { id: 'nw36', date: '01/07/2014', title: 'Dual-function graphene-based electronic devices', source: 'SPIE', type: 'News', link: 'http://spie.org/newsroom/5193-dual-function-graphene-based-electronic-devices' },
  { id: 'nw37', date: '13/12/2012', title: 'Rigid Electronics Stretch to New Lengths', source: 'Materials360 Online', type: 'News', link: 'http://graphene.yonsei.ac.kr/upload_hi/pdf_hi/pdf%ED%8C%8C%EC%9D%BC%EB%AA%85' },
  { id: 'nw38', date: '30/11/2011', title: 'Stretchy graphene transistors', source: 'Nature article: Materials science', type: 'News', link: 'http://www.nature.com/nature/journal/v480/n7375/full/480009f.html' },
  { id: 'nw39', date: '26/10/2011', title: 'Stretchable graphene transistors overcome limitations of other materials', source: 'PHYSORG', type: 'News' },
  { id: 'nw40', date: '14/06/2011', title: '그래핀 고체윤활막 개발', source: '연합뉴스', type: 'News' },
  { id: 'nw41', date: '11/04/2011', title: 'Microactuators: Graphene on dragonfly wings', source: 'Nature asia-pacific', type: 'News', link: 'http://www.nature.com/am/journal/2011/201104/full/am201181a.html' },
  { id: 'nw42', date: '11/04/2011', title: '2011 한국을 이끄는 혁신리더 선정', source: 'NewsMaker', type: 'News' },
  { id: 'nw43', date: '26/01/2011', title: 'Interview', source: '주간조선', type: 'News', link: 'http://weekly.chosun.com/client/news/viw.asp?ctcd=C05&nNewsNumb=002145100025' },
  { id: 'nw44', date: '26/01/2011', title: 'Commercialization of graphene', source: '아이뉴스24', type: 'News', link: 'http://news.inews24.com/php/news_view.php?g_serial=546045&g_menu=020200' },
  { id: 'nw45', date: '26/04/2010', title: 'Mechanically flexible thin film transistors and logic gates on plastic substrates', source: 'Applied Physics Letters, 한겨레, 연합뉴스 등', type: 'News' },
  { id: 'nw46', date: '24/12/2010', title: '2010 SKKU 10 News', source: '성균관대학교', type: 'News', link: 'http://graphene.yonsei.ac.kr/upload_hi/pdf_hi/2010%20SKKU%2010%20News' },
  { id: 'nw47', date: '22/12/2010', title: 'Miracle material, Graphene', source: '아시아경제', type: 'News', link: 'http://www.asiae.co.kr/news/view.htm?idxno=2010122210234436377' },
  { id: 'nw48', date: '14/12/2010', title: '10 news of science & technology', source: '서울신문', type: 'News', link: 'http://www.seoul.co.kr/news/newsView.php?id=20101214023003' },
  { id: 'nw49', date: '08/10/2010', title: 'Next generation material, Graphene', source: '매일경제', type: 'News', link: 'http://news.mk.co.kr/newsReadPrint.php?year=2010&no=540003' },
  { id: 'nw50', date: '23/08/2010', title: 'People & People', source: '주간동아', type: 'News', link: 'http://weekly.donga.com/List/3/all/11/90580/1' },
  { id: 'nw51', date: '22/07/2010', title: '3-dimentional packaging', source: '중앙일보', type: 'News', link: 'http://news.joins.com/article/4329527' },
  { id: 'nw52', date: '21/06/2010', title: 'Roll-to-roll production of 30-inch graphene films', source: 'Nature Nanotechnology, BBC 등', type: 'News' },
  { id: 'nw53', date: '27/02/2009', title: '2008 SKKU-Young Fellow 수상', source: '성균관대학교', type: 'News', link: 'http://www.skku.edu/e-home-s/news/popup_notice.jsp?mode=read&physical_num=11528' },
  { id: 'nw54', date: '21/08/2008', title: 'Flexible and Stretchable and Transparent Integrated Circuits', source: '한겨레', type: 'News', link: 'http://www.hani.co.kr/popups/print.hani?ksn=305713' },
  { id: 'nw55', date: '03/04/2008', title: 'Bendy Electronics', source: 'Nature', type: 'News', link: 'http://graphene.yonsei.ac.kr/upload_hi/pdf_hi/Bendy%20Electronics' },
  { id: 'nw56', date: '28/03/2008', title: 'Stretchable and Foldable Integrated Circuits', source: '조선일보, 동아일보 등', type: 'News' },
  { id: 'nw57', date: '27/03/2008', title: 'Silicon chips stretch into shape', source: '영국 BBC', type: 'News', link: 'http://news.bbc.co.uk/2/hi/technology/7313203.stm' },
  { id: 'nw58', date: '01/03/2008', title: 'Printing CMOS on Plastic', source: 'IEEE Spectrum', type: 'News', link: 'http://graphene.yonsei.ac.kr/upload_hi/pdf_hi/Printing%20CMOS%20on%20Plastic' },
  { id: 'nw59', date: '01/05/2007', title: 'Bendable Integrated Circuits on Plastic Substrates', source: 'Applied Physics Letters', type: 'News' },
  { id: 'nw60', date: '30/12/2006', title: 'Top advances in Nanotechnology for 2006', source: 'MIT Technology Review', type: 'News', link: 'https://www.technologyreview.com/s/407049/the-year-in-nanotech/' },
  { id: 'nw61', date: '22/12/2006', title: 'Mix n Match Flexible Circuitry May Brighten Cell Phone', source: 'Scientific American', type: 'News', link: 'http://www.scientificamerican.com/article/mix-n-match-flexible-circ/' },
  { id: 'nw62', date: '18/12/2006', title: 'Stamping Electronics', source: 'Chemical & Engineering News', type: 'News', link: 'http://graphene.yonsei.ac.kr/upload_hi/pdf_hi/Stamping%20Electronics' },
  { id: 'nw63', date: '15/12/2006', title: 'New Semiconductor Technology Created', source: 'United Press International', type: 'News', link: 'http://graphene.yonsei.ac.kr/upload_hi/pdf_hi/New%20Semiconductor%20Technology%20Created' }
];
